...
**What this chapter settles:** which powered things belong to the kitchen's equipment, so every restaurant in the chain counts the same kind of thing.
...
Ask three questions about each thing:

1. Is it powered?
2. Does it do work for you?
3. Is it a thing in its own right, rather than part of the building, a piece of furniture or a utensil?

**A thing belongs to equipment only when all three answers are yes.** This test matters across the chain because names can mislead. Two restaurants may call similar things by different names. The same three questions still place them in the same category.

## Powered things stay separate from the things around them

A thing does not become equipment merely because it stands in the kitchen. The building with doors is not equipment. Furniture is carried in and placed. Utensils are picked up and worked by hand. **Equipment is set apart by its own power doing work.**
