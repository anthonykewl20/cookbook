...
Each role may touch its own work and must stop at its boundary.
...
| Taster | Checks the dish | Cooking that dish |
...
| Who | Asks | Checks |
|---|---|---|
| Head chef | “Was the process followed?” | The method |
...
1. Name everyone who works in the kitchen by role, never by person.
